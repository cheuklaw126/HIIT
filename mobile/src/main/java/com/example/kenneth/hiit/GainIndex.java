...
public class GainIndex extends AppCompatActivity {
    SQLiteDatabase db;
    BarChart chart ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gain_index);
        ...
        Bardataset = new BarDataSet(BARENTRY, "Gain Index");
    ...
    public void AddValuesToBARENTRY(){
        ...
        if (cursor1.getCount() > 0) {
            ...
            while (cursor1.moveToNext()) {
                ...
                GI = Float.parseFloat(cursor1.getString(cursor1.getColumnIndex("eg")));
                BARENTRY.add(new BarEntry(GI, gindex));
                System.out.println("HDATE, GI, count , gindex = " + HDATE + " , " + GI+ " , " + cursor1.getCount()+ " , " +gindex);
                gindex++;
            }
           }
    }
