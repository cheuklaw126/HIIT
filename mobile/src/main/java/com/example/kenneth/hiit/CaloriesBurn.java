...
public class CaloriesBurn extends AppCompatActivity {
    SQLiteDatabase db;
    BarChart chart ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.calories_burn);
        ...
        Bardataset = new BarDataSet(BARENTRY, "Calories Burn (cal)");
    ...
    public void AddValuesToBARENTRY(){
        ...
        if (cursor1.getCount() > 0) {
            ...
            while (cursor1.moveToNext()) {
                ...
                CB = Float.parseFloat(cursor1.getString(cursor1.getColumnIndex("cc")));
                BARENTRY.add(new BarEntry(CB, gindex));
                System.out.println("HDATE, CB, count , gindex = " + HDATE + " , " + CB+ " , " + cursor1.getCount()+ " , " +gindex);
                gindex++;
            }
        }
    }
