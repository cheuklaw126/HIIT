...
public class HeartRate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bardataset = new BarDataSet(BARENTRY, "Average Heart Rate (bpm)");
    ...
    public void AddValuesToBARENTRY(){
        ...
        if (cursor1.getCount() > 0) {
            ...
            while (cursor1.moveToNext()) {
                ...
                HR = Float.parseFloat(cursor1.getString(cursor1.getColumnIndex("hr")));
                BARENTRY.add(new BarEntry(HR, gindex));
                System.out.println("HDATE, HR, count , gindex = " + HDATE + " , " + HR+ " , " + cursor1.getCount()+ " , " +gindex);
                gindex++;
            }
        }
    }
